      ...
      <Card shadow="sm" p="lg" w={{ base: "1000px" }} radius="md" withBorder>
        <Card.Section>
          <Group position="apart" mt="xs" ml="md" mr="md">
            <Title order={3}>Gift Cards</Title>
            <Button size="xs" onClick={() => router.push("giftcards/new")}>
              New Gift Card
            </Button>
          </Group>
          <Divider my="sm" />
        ...
        <Card.Section p="md" pt="xs">
          <DataTable
            ...
            noRecordsText="No gift cards found"
            columns={[
              { accessor: "code" },
              {
                accessor: "state",
              ...
              },
              {
                ...
                render: row => (
                  <>
                    {row.expiresAt !== null
                      ? DateTime.fromJSDate(row.expiresAt).toFormat(
                          "LLL dd, yyyy",
                        )
                      : "N/A"}
                  </>
